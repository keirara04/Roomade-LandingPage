  ...
  return (
    <section className="w-full max-w-3xl px-6 py-20 text-center">
      <RevealOnScroll>
        ...
        <p className="mx-auto mt-4 max-w-lg text-base leading-7 text-paper/85">
          ...
          spare key,&rdquo; and three days of silence. Nothing has a status.
          Nothing resolves. It just scrolls.
        </p>
      </RevealOnScroll>
    </section>
  );
